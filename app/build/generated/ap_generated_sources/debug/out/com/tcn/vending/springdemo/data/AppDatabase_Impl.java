...
import com.tcn.vending.springdemo.data.dao.ActivoDao_Impl;
import com.tcn.vending.springdemo.data.dao.CeldaDao;
import com.tcn.vending.springdemo.data.dao.CeldaDao_Impl;
import com.tcn.vending.springdemo.data.dao.ShipmentDao;
import com.tcn.vending.springdemo.data.dao.ShipmentDao_Impl;
import com.tcn.vending.springdemo.data.dao.UserDao;
import com.tcn.vending.springdemo.data.dao.UserDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `shipment` (`mId` TEXT NOT NULL, `mCreatedAt` INTEGER NOT NULL, `mIdCelda` TEXT, `mIdActivo` TEXT, `mKeyActivo` TEXT, `mObjectType` TEXT, `mCodeUsuario` TEXT, `mIsVerified` INTEGER NOT NULL, `estado` INTEGER NOT NULL, PRIMARY KEY(`mId`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS `activo` (`idCelda` TEXT NOT NULL, `slotN` INTEGER NOT NULL, `celdaName` TEXT, `activoId` TEXT, `activoName` TEXT, `activoType` TEXT, `activoBrand` TEXT, `activoMode` TEXT, `cantidad` INTEGER NOT NULL, `celdas` REAL NOT NULL, `row` INTEGER NOT NULL, `enabled` INTEGER NOT NULL, PRIMARY KEY(`idCelda`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"fde8d5d3c3a83fa418fa9d70b21aa2a5\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoCelda.equals(_existingCelda)) {
          throw new IllegalStateException("Migration didn't properly handle celda(com.tcn.vending.springdemo.data.models.Celda).\n"
                  + " Expected:\n" + _infoCelda + "\n"
                  + " Found:\n" + _existingCelda);
        }
        ...
        if (! _infoUser.equals(_existingUser)) {
          throw new IllegalStateException("Migration didn't properly handle user(com.tcn.vending.springdemo.data.models.User).\n"
                  + " Expected:\n" + _infoUser + "\n"
                  + " Found:\n" + _existingUser);
        }
        ...
        _columnsShipment.put("mCodeUsuario", new TableInfo.Column("mCodeUsuario", "TEXT", false, 0));
        ...
        if (! _infoShipment.equals(_existingShipment)) {
          throw new IllegalStateException("Migration didn't properly handle shipment(com.tcn.vending.springdemo.data.models.Shipment).\n"
                  + " Expected:\n" + _infoShipment + "\n"
                  + " Found:\n" + _existingShipment);
        }
        final HashMap<String, TableInfo.Column> _columnsActivo = new HashMap<String, TableInfo.Column>(12);
        ...
        _columnsActivo.put("celdaName", new TableInfo.Column("celdaName", "TEXT", false, 0));
        _columnsActivo.put("activoId", new TableInfo.Column("activoId", "TEXT", false, 0));
        _columnsActivo.put("activoName", new TableInfo.Column("activoName", "TEXT", false, 0));
        _columnsActivo.put("activoType", new TableInfo.Column("activoType", "TEXT", false, 0));
        _columnsActivo.put("activoBrand", new TableInfo.Column("activoBrand", "TEXT", false, 0));
        _columnsActivo.put("activoMode", new TableInfo.Column("activoMode", "TEXT", false, 0));
        _columnsActivo.put("cantidad", new TableInfo.Column("cantidad", "INTEGER", true, 0));
        _columnsActivo.put("celdas", new TableInfo.Column("celdas", "REAL", true, 0));
        ...
        if (! _infoActivo.equals(_existingActivo)) {
          throw new IllegalStateException("Migration didn't properly handle activo(com.tcn.vending.springdemo.data.models.Activo).\n"
                  + " Expected:\n" + _infoActivo + "\n"
                  + " Found:\n" + _existingActivo);
        }
      }
    }, "fde8d5d3c3a83fa418fa9d70b21aa2a5", "ec9cbb491491c55ece70a7fea9a3df61");
