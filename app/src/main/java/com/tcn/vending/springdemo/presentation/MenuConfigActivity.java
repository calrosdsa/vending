...
import com.tcn.sdk_auth_lib.auth.TcnAuthSdk;
import com.tcn.springboard.control.PayMethod;
import com.tcn.springboard.control.TcnDriveType;
...
import com.tcn.vending.springdemo.presentation.components.buttons.ButtonEditSelectD;
import com.tcn.vending.springdemo.presentation.components.buttons.ButtonSwitch;
import com.tcn.vending.springdemo.R;
import java.util.List;
import java.util.concurrent.ThreadLocalRandom;

public class MenuConfigActivity extends TcnMainActivity {
...
//        }
    ...
    private void initView() {
        ...
        if (m_Titlebar != null) {
            ...
            m_Titlebar.setButtonName("Menú de Configuración");
        ...
        menu_lift_display_price = (ButtonEditSelectD) findViewById(R.id.menu_spring_display_price);
        if (menu_lift_display_price != null) {
            ...
            menu_lift_display_price.setButtonQueryText("设置");//Setting
            menu_lift_display_price.setButtonName("选择货道并设置价格");//Select a slot and set the price
        ...
        if (menu_spr_ship_slot != null) {
            ...
            menu_spr_ship_slot.setButtonName("Ejemplo de envío");//commodity dispensing test
            menu_spr_ship_slot.setButtonNameTextSize(TcnVendIF.getInstance().getFitScreenSize(20));
            menu_spr_ship_slot.setButtonQueryText("Dispensar");//Ship
        ...
        if (menu_spr_ship_slot_test != null) {
            ...
            menu_spr_ship_slot_test.setButtonName("Carril de carga de prueba");//Test slot
        ...
        if (menu_spr_reqselect != null) {
            ...
            menu_spr_reqselect.setButtonName("选择货道");//Choose slot
            menu_spr_reqselect.setButtonNameTextSize(TcnVendIF.getInstance().getFitScreenSize(20));
            menu_spr_reqselect.setButtonQueryText("选择");//select
        ...
        if (menu_spr_set_slot_spring != null) {
            ...
            menu_spr_set_slot_spring.setButtonName("Establecer como spring slot");
        ...
        if (menu_spr_set_slot_belts != null) {
            ...
            menu_spr_set_slot_belts.setButtonName("Establecer como belt slot");
        ...
        if (menu_spr_set_slot_spring_all != null) {
            ...
            menu_spr_set_slot_spring_all.setButtonName("Establecer todo como spring slot");
        ...
        if (menu_spr_set_slot_belts_all != null) {
            ...
            menu_spr_set_slot_belts_all.setButtonName("Establecer todo como belt slot");
        ...
        if (menu_spr_set_single_slot != null) {
            ...
            menu_spr_set_single_slot.setButtonName("Dividir en una sola celda");
            menu_spr_set_single_slot.setButtonNameTextSize(TcnVendIF.getInstance().getFitScreenSize(20));
            menu_spr_set_single_slot.setButtonQueryText("Dividir");
        ...
        if (menu_spr_set_double_slot != null) {
            ...
            menu_spr_set_double_slot.setButtonName("Unir con la siguiente celda");
            menu_spr_set_double_slot.setButtonNameTextSize(TcnVendIF.getInstance().getFitScreenSize(20));
            menu_spr_set_double_slot.setButtonQueryText("Unir");
        ...
        func_gezij_set_btn = (Button) findViewById(R.id.func_gezij_set_btn);
        ...
        func_5inch_board_btn = (Button) findViewById(R.id.func_5inch_board_btn);
    ...
    private class MenuSetTitleBarListener implements Titlebar.TitleBarListener {
        ...
        public void onClick(View v, int buttonId) {
            if (Titlebar.BUTTON_ID_BACK == buttonId) {MenuConfigActivity.this.finish();
            }
        }
    }
...
//		}
        builder.setPositiveButton(getString(R.string.background_backgroound_ensure), new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                if (m_OutDialog == null) {
                    m_OutDialog = new OutDialog(MenuConfigActivity.this, "", getString(R.string.background_drive_setting));
        ...
        public void onClick(View v) {
            ...
            if (R.id.func_coin_open_set_btn == id) {
                ...
                if (TcnVendIF.getInstance().isDigital(mData) && (mData.trim().length() == 16)) {
                    ...
                    TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.background_func_paper_coin_open_tips));
                }
                ...
                if (null == m_DialogFillCash) {
                    m_DialogFillCash = new DialogInput(MenuConfigActivity.this);
                ...
                Intent in = new Intent(MenuConfigActivity.this, MenuSettingsLatticeActivity.class);
                startActivity(in);
            } else if (R.id.func_5inch_board_btn == id) {
                Intent in = new Intent(MenuConfigActivity.this, MenuSettingsStandJsActivity.class);
                startActivity(in);
            }
            else {
    ...
    private class ButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (R.id.main_serport == mId) {
                ...
                Intent in = new Intent(MenuConfigActivity.this, SerialPortSetting.class);
            ...
            if (R.id.menu_spring_display_price == id) {
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if (!TcnVendIF.getInstance().isDigital(strParamSecond)) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.background_lift_tips_select_set_parameters));
                    } else {
                        ...
                        if (TcnVendIF.getInstance().isDigital(strInputValue) || TcnVendIF.getInstance().isContainDeciPoint(strInputValue)) {
                            ...
                            TcnUtilityUI.getToast(MenuConfigActivity.this, "价格不正确"); //The price is incorrect
                        }
                    }
...
//							"",UIComBack.SLOT_LIST);
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.background_drive_tips_input_slotno));
                    } else {
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        ...
                        long randomN = ThreadLocalRandom.current().nextLong(100);
                        ...
                        String tradeNo = String.valueOf(randomN);//支付订单号，每次出货，订单号不能一样，此处自己修改。 Transaction number, it cannot be the same number and should be different every time. you can modify it by yourself.
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if (UIComBack.getInstance().isMutiGrpSpring()) {
                        ...
                        if ((null == strParam) || (strParam.length() < 1)) {
                            TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.background_drive_tips_select_cabinetno));
                        } else {
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParamSecond) || (strParamSecond.length() < 1)) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.background_lift_tips_select_control_action));
                    } else {
                        if ((UIComBack.HEAT_COOL_OFF_SWITCH_SELECT[0]).equals(strParamSecond)) {
                            ...
                            if (!TcnVendIF.getInstance().isNumeric(temp)) {
                                TcnUtilityUI.getToast(MenuConfigActivity.this, "请填入温度值"); //Please fill in the temperature value
                                return;
                            }
                            String startTime = menu_spr_set_heat_cool_start_time.getText().toString();
                            if (!TcnVendIF.getInstance().isDigital(startTime)) {
                                TcnUtilityUI.getToast(MenuConfigActivity.this, "请填入制冷开始时间"); //Please fill in the time when turn on refrigeration
                                return;
                            }
                            String endTime = menu_spr_set_heat_cool_end_time.getText().toString();
                            if (!TcnVendIF.getInstance().isDigital(endTime)) {
                                TcnUtilityUI.getToast(MenuConfigActivity.this, "请填入制冷结束时间");//Please fill in the time when turn off refrigeration
                                return;
                            }
                            ...
                            String startTime = menu_spr_set_heat_cool_start_time.getText().toString();
                            if (!TcnVendIF.getInstance().isDigital(startTime)) {
                                TcnUtilityUI.getToast(MenuConfigActivity.this, "请填入加热开始时间"); //Please fill in the time when turn on heating
                                return;
                            }
                            String endTime = menu_spr_set_heat_cool_end_time.getText().toString();
                            if (!TcnVendIF.getInstance().isDigital(endTime)) {
                                TcnUtilityUI.getToast(MenuConfigActivity.this, "请填入加热结束时间");//Please fill in the time when turn off heating
                                return;
                            }
            ...
            /* else if (R.id.menu_spr_set_temp == id) {
               if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if (UIComBack.getInstance().isMutiGrpSpring()) {
                        ...
                        if ((null == strParam) || (strParam.length() < 1)) {
                            TcnUtilityUI.getToastMenuConfigActivity.this, getString(R.string.background_drive_tips_select_cabinetno));
                        } else {
                            String strParamSecond = menu_spr_set_temp.getButtonEditTextSecond();
                            if ((null == strParamSecond) || (strParamSecond.length() < 1)) {
                                TcnUtilityUI.getToastMenuConfigActivity.this, getString(R.string.lift_tips_select_control_action));
                            } else {
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        ...
                        showSetConfirm(CMD_SET_SLOTNO_SPRING,"",strParam,String.format("¿Desea definir la celda número %s como sprig?",strParam));
                    }
                }
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        ...
                        showSetConfirm(CMD_SET_SLOTNO_BELTS,"",strParam,String.format("¿Desea definir la celda número %s como belt?",strParam));
                    }
                }
                    ...
                    if (UIComBack.getInstance().isMutiGrpSpring()) {
                        ...
                        if ((null == strParam) || (strParam.length() < 1)) {
                            ...
                            showSetConfirm(CMD_SET_SLOTNO_ALL_SPRING,String.valueOf(UIComBack.getInstance().getGroupSpringId(strParam)),"",
                                    "¿Está seguro de establecer todos los celdas como spring?");
                        }
                    } else {
                        showSetConfirm(CMD_SET_SLOTNO_ALL_SPRING,"","","¿Está seguro de establecer todos los celdas como spring?");
                    }
                    ...
                    if (UIComBack.getInstance().isMutiGrpSpring()) {
                        ...
                        if ((null == strParam) || (strParam.length() < 1)) {
                            ...
                            showSetConfirm(CMD_SET_SLOTNO_ALL_BELT,String.valueOf(UIComBack.getInstance().getGroupSpringId(strParam)),"",
                                    "¿Está seguro de establecer todos las celdas como belt?");
                        }
                    } else {
                        showSetConfirm(CMD_SET_SLOTNO_ALL_BELT,"","","¿Está seguro de establecer todos las celdas como belt?");
                    }
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        ...
                        showSetConfirm(CMD_SET_SLOTNO_SINGLE,"",strParam,String.format("¿Está seguro de establecer la celda %s como única?",strParam));
                    }
                ...
                if (ButtonEditSelectD.BUTTON_ID_QUERY == buttonId) {
                    ...
                    if ((null == strParam) || (strParam.length() < 1)) {
                        ...
                        showSetConfirm(CMD_SET_SLOTNO_DOUBLE,"",strParam,String.format("¿Está seguro que desea unir la celda %s con la siguiente?",strParam));
                    }
                }
        ...
        public void VendEvent(VendEventInfo cEventInfo) {
            ...
            switch (cEventInfo.m_iEventID) {
                ...
                case TcnVendEventID.CMD_SET_COOL: //设置制冷 Set up cooling
                    ...
                    TcnUtilityUI.getToast(MenuConfigActivity.this, cEventInfo.m_lParam4);
                    break;
                ...
                case TcnVendEventID.COMMAND_SYSTEM_BUSY:
                    TcnUtilityUI.getToast(MenuConfigActivity.this, cEventInfo.m_lParam4, 20).show();
                    break;
                ...
                case TcnVendEventID.COMMAND_SELECT_GOODS:  //选货成功  Select commodity successfully
                    TcnUtilityUI.getToast(MenuConfigActivity.this, "选货成功"); //Select commodity successfully
                    break;
                case TcnVendEventID.COMMAND_INVALID_SLOTNO:
                    TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.ui_base_notify_invalid_slot), 22).show();
                    break;
                case TcnVendEventID.COMMAND_SOLD_OUT:
                    if (cEventInfo.m_lParam1 > 0) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.ui_base_aisle_name) + cEventInfo.m_lParam1 + getString(R.string.ui_base_notify_sold_out));
                    } else {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.ui_base_notify_sold_out));
                    }
                    break;
                ...
                case TcnVendEventID.COMMAND_SHIPPING:    //正在出货 commodity is dispensing
                    if ((cEventInfo.m_lParam4 != null) && ((cEventInfo.m_lParam4).length() > 0)) {
                        if (m_OutDialog == null) {
                            m_OutDialog = new OutDialog(MenuConfigActivity.this, String.valueOf(cEventInfo.m_lParam1), cEventInfo.m_lParam4);
                        } else {
                        ...
                        if (m_OutDialog == null) {
                            m_OutDialog = new OutDialog(MenuConfigActivity.this, String.valueOf(cEventInfo.m_lParam1), getString(R.string.ui_base_notify_shipping));
                        } else {
                            m_OutDialog.setNumber(MenuConfigActivity.this.getString(R.string.ui_base_notify_shipping));
                        }
                    }
                ...
                case TcnVendEventID.COMMAND_SHIPMENT_SUCCESS:    //出货成功 commodity is dispensed successfully
                    ...
                    if (m_LoadingDialog == null) {
                        m_LoadingDialog = new LoadingDialog(MenuConfigActivity.this, getString(R.string.ui_base_notify_shipment_success), getString(R.string.ui_base_notify_receive_goods), new Clear() {
                            @Override
                ...
                case TcnVendEventID.COMMAND_SHIPMENT_FAILURE:    //出货失败 commodity delivery failed
                    ...
                    if (null == m_LoadingDialog) {
                        m_LoadingDialog = new LoadingDialog(MenuConfigActivity.this, getString(R.string.ui_base_notify_shipment_fail), getString(R.string.ui_base_notify_contact_merchant), new Clear() {
                            @Override
                            public void clearData() {
                                //TODO()
                            }
                ...
                case TcnVendEventID.CMD_READ_DOOR_STATUS:  //门动作上报 Door action report
                    if (TcnVendEventResultID.DO_CLOSE == cEventInfo.m_lParam1) {   //关门 close the door
                        TcnUtilityUI.getToast(MenuConfigActivity.this, "关门", 20).show();
                    } else if (TcnVendEventResultID.DO_OPEN == cEventInfo.m_lParam1) {   //开门 Open the door
                        TcnUtilityUI.getToast(MenuConfigActivity.this, "开门", 20).show();
                    }
                    else {
...
//					}
                ...
                case TcnVendEventID.CMD_REQ_PERMISSION:     //授权访问文件夹 Authorize access to folders
                    ...
                    TcnUtilityUI.getToast(MenuConfigActivity.this, "请选择确定");
//                    ActivityCompat.requestPermissions(MenuConfigActivity.this,TcnVendIF.getInstance().getPermission(cEventInfo.m_lParam4),126);
                    break;
                case TcnVendEventID.MDB_RECIVE_PAPER_MONEY:
                    String strBalance = TcnVendIF.getInstance().getBalance();  //余额 Balance
                    TcnUtilityUI.getToast(MenuConfigActivity.this, cEventInfo.m_lParam4 + "元", 20).show(); //yuan
                    break;
                ...
                case TcnVendEventID.MDB_PAYOUT_PAPERMONEY:
                    if (cEventInfo.m_lParam1 == TcnVendEventResultID.MDB_PAYOUT_START) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.ui_base_notify_coin_back), 20).show();
                ...
                case TcnVendEventID.MDB_PAYOUT_COINMONEY:
                    if (cEventInfo.m_lParam1 == TcnVendEventResultID.MDB_PAYOUT_START) {
                        TcnUtilityUI.getToast(MenuConfigActivity.this, getString(R.string.ui_base_notify_coin_back));
                    } else if (cEventInfo.m_lParam1 == TcnVendEventResultID.MDB_PAYOUT_END) {
                        if ((cEventInfo.m_lParam4 != null) && ((cEventInfo.m_lParam4).length() > 0)) {
                            TcnUtilityUI.getToast(MenuConfigActivity.this, cEventInfo.m_lParam4);
                        } else {
                            TcnUtilityUI.getToast(MenuConfigActivity.this,getString(R.string.ui_base_notify_coinback_success));
                        }
                ...
                case TcnVendEventID.MDB_QUERY_PAPER_MONEY:   //查询到的纸币信息
                    ...
                    List<MdbInfoBean> mdbInfoBeanPaperList = gsonPaper.fromJson(cEventInfo.m_lParam4, new TypeToken<List<MdbInfoBean>>() {}.getType());

                    break;
                case TcnVendEventID.MDB_QUERY_COIN:   //   //查询到的硬币信息
                    Gson gsonCoin = new Gson();
                    List<MdbInfoBean> mdbInfoBeanCoinList = gsonCoin.fromJson(cEventInfo.m_lParam4, new TypeToken<List<MdbInfoBean>>() {}.getType());
                    break;
