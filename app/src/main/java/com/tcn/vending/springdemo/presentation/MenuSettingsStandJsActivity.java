...
import com.tcn.springboard.control.ConstantsDrive5inch;
import com.tcn.springboard.control.MessageFromDrive;
import com.tcn.springboard.control.MessageFromUI0203Crc;
import com.tcn.springboard.control.TcnDriveCmdType;
import com.tcn.springboard.control.TcnDrivesConstant;
...
public class MenuSettingsStandJsActivity extends TcnMainActivity {
	...
	private void initView() {
		...
		menu_ys_light_check = (ButtonSwitch) findViewById(R.id.menu_ys_light_check);
		if (menu_ys_light_check != null) {
		...
		menu_ys_query_drive_fault = (ButtonEditSelectD) findViewById(R.id.menu_ys_query_drive_fault);
		if (menu_ys_query_drive_fault != null) {
//			menu_ys_query_drive_fault.setButtonType(ButtonEditSelectD.BUTTON_TYPE_QUERY);
		...
		menu_ys_clear_drive_fault = (ButtonEditSelectD) findViewById(R.id.menu_ys_clear_drive_fault);
		if (menu_ys_clear_drive_fault != null) {
		...
		menu_ys_query_drive_info = (ButtonEditSelectD) findViewById(R.id.menu_ys_query_drive_info);
		if (menu_ys_query_drive_info != null) {
		...
		menu_ys_action = (ButtonEditSelectD) findViewById(R.id.menu_ys_action);
		if (menu_ys_action != null) {
		...
		menu_ys_query_param = (ButtonEditSelectD) findViewById(R.id.menu_ys_query_param);
		if (menu_ys_query_param != null) {
		...
		menu_ys_set_param_select = (ButtonEditSelectD) findViewById(R.id.menu_ys_set_param_select);
		if (menu_ys_set_param_select != null) {
