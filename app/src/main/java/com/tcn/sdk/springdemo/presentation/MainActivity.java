...
import com.tcn.sdk.springdemo.presentation.components.buttons.CustomAlertDialog;
...
//                    showAlertMessage("El activo que has seleccionado parece no estar en tu inventario.","No permitido");
                ...
                alertDialog.setLoadText(getString(R.string.confirmar_dipensar_text,"Maouse Rowel"));
...
//                    TcnUtilityUI.getToast(ComposeActivity.this, cEventInfo.m_lParam4, 20).show();
                ...
                case TcnVendEventID.COMMAND_SHIPMENT_FAILURE:
                    ...
                    showAlertMessage(loadText2,loadTitle1);
...
//                    TcnUtilityUI.getToast(ComposeActivity.this, cEventInfo.m_lParam4, 20).show();
                ...
                case TcnVendEventID.COMMAND_SHIPMENT_SUCCESS:
                    showAlertMessage("Se ha dispensado con éxito y se ha actualizado su inventario","Operación exitosa");
//                    AsyncTask.execute(()->{
